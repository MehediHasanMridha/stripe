        ...
        <div class="container">
            ...
            <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">{{ __("textes.arianne_conseiller_editer") }}</li>
                </ol>
            </nav>
        </div>
        <div class="container">
            <div class="row">
                <div class="col">
                    <h2 class="text-center my-3">{{__("textes.compte_conseillers_edit_title")}}</h2>
                </div>
            </div>
            <div class="row mt-5">
                ...
                <form action="{{ route('compte.conseillers.update') }}" method="post">
                    ...
                    <div class="col-xxl-5 col text-size phone-margin">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="nom" id="nom" value="{{$praticien->nom}}" class="form-control">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="adresse" id="adresse" value="{{$praticien->adresse}}"
                                   class="form-control">

                            <label for="cp" class="form-label">{{__("textes.conseillers_create_postal")}}</label>
                            <input type="number" name="cp" id="cp" value="{{$praticien->CP}}" class="form-control">

                            <label for="vile" class="form-label">{{__("textes.conseillers_create_ville")}}</label>
                            <input type="text" name="ville" id="ville" value="{{$praticien->ville}}"
                                   class="form-control">

                            <label for="departement"
                                   class="form-label">{{ __("textes.conseillers_create_departement") }}</label>
                            <input type="text" name="departement" id="departement" value="{{$praticien->departement}}"
                                   class="form-control">

                            <label for="region" class="form-label">{{ __("textes.conseillers_create_region") }}</label>
                            <input type="text" name="region" id="region" value="{{$praticien->region}}"
                                   class="form-control">
                        </div>

                        <!---------- ADRESSE 2 ---------->
                        <div class="d-flex align-items-center">
                            <label class="form-label label-name create-size">
                                <i class="fas fa-map-marker-alt me-4"></i>{{__("textes.conseillers_show_adresse")}}2</label>
                        </div>

                        <div class="mb-3">
                            <label for="adresse2" class="form-label">{{__("textes.conseillers_create_adresse")}}</label>
                            <input type="text" name="adresse2" id="adresse2" value="{{$praticien->adresse2}}"
                                   class="form-control">

                            <label for="cp2" class="form-label">{{__("textes.conseillers_create_postal")}}</label>
                            <input type="number" name="cp2" id="cp2" value="{{$praticien->CP2}}" class="form-control">

                            <label for="ville2" class="form-label">{{__("textes.conseillers_create_ville")}}</label>
                            <input type="text" name="ville2" id="ville2" value="{{$praticien->ville2}}"
                                   class="form-control">

                            <label for="departement2"
                                   class="form-label">{{ __("textes.conseillers_create_departement") }}</label>
                            <input type="text" name="departement2" id="departement2"
                                   value="{{$praticien->departement2}}" class="form-control">

                            <label for="region2" class="form-label">{{ __("textes.conseillers_create_region") }}</label>
                            <input type="text" name="region2" id="region2" value="{{$praticien->region2}}"
                                   class="form-control">
                        </div>
                        ...
                        <div class="my-3">
                            ...
                            <input type="tel" name="tel" id="tel" value="{{$praticien->mobile}}" class="form-control">

                            <label for="email" class="form-label">{{__("textes.conseillers_create_mail")}}</label>
                            <input type="email" name="email" id="email" value="{{$praticien->email}}"
                                   class="form-control">
                        </div>
                        ...
                        <div class="mb-3" id="horaires-show">
                            ...
                            <textarea type="text" class="form-control create-size" id="horaires" rows="3"
                                      aria-describedby="horaires" name="horaires">{{$praticien->horaires}}</textarea>
                    ...
                    <button class="btn btn-small-plus-conseiller mt-3" type="submit"><span
                            class="text-white save-btn">{{ __("textes.conseillers_edit_btn") }}</span></button>
                </form>
            </div>
