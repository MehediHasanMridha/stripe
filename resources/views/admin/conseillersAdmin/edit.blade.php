        ...
        <div class="container-fluid container-xl">
            <div class="mb-3 mt-4">
                ...
                <div class="d-flex align-items-center justify-content-between">
                    ...
                    <h3> {{__("textes.conseillersAdmin_edit_practicien")}} </h3>
            ...
            <div class="row mt-5">
                <form action="{{ route('conseillersAdmin.update', [$praticien->id]) }}" method="POST"
                    ...
                    <div class="col-xxl-5 col text-size phone-margin">
                        ...
                        <!--<label for="prenom" class="form-label">{{ __("textes.conseillersAdmin_create_prenom") }}</label>
                        ...
                        <!-- Modification des horaires d'un conseiller -->
                    ...
                    <button class="btn btn-small-plus-conseiller mt-3" type="submit"><span
                            class="text-white save-btn"> {{ __("textes.conseillersAdmin_edit_conseillers") }} </span>
                    </button>
                </form>
            </div>
        </div>
