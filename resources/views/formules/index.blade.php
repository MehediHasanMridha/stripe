        ...
        <div class="container">
            ...
            <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">{{ __("textes.arianne_formules") }}</li>
                </ol>
            </nav>
        </div>
            ...
            <div class="row">
                <div class="col">
                    ...
                    <div class="d-flex flex-column align-items-center mt-4">
                        <a href="{{ route('formules.liste', ['cn']) }}" class="btn btn-large text-white">
                            <span class="btn-text">{{ __("textes.formules_index_btn_text_zh") }}</span>
                        </a>
                        <a href="{{ route('formules.liste', ['fr']) }}" class="btn btn-large text-white">
                            <span class="btn-text">{{ __("textes.formules_index_btn_text_fr") }}</span>
                        </a>
                    </div>
                </div>
            </div>
