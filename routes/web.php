...
Route::group([
    ...
    Route::post('/compte', 'CompteController@delete')->name('compte.delete');
    Route::post('/compte_delete', 'CompteController@deleteUser')->name('compte.deleted');
    // Stripe
...
/*  Accesible par les Praticiens Conseillers */
Route::group([
    "middleware"=>"level:3",
],function () {
